...
const ARTIFACTS = [
  { label: "Standard Operating Procedure (SOP)", desc: "Human-readable audit narrative with findings, risk flags, and recommendations.", color: "#22d3ee" },
  { label: "Dataset Data Card",                   desc: "JSON-LD structured dataset metadata following established card schemas.",         color: "#10b981" },
  { label: "Model Card",                          desc: "Behavioral documentation for registered models with explanation artifacts.",      color: "#a78bfa" },
  { label: "Privacy Report",                      desc: "PII findings, pseudonymisation decisions, and residual risk assessment.",        color: "#38bdf8" },
  { label: "Field Inventory",                     desc: "Schema manifest: field names, types, sparsity, and PII classification.",         color: "#22d3ee" },
  { label: "Audit Manifest",                      desc: "Signed record of what was analyzed, when, with which recipe and outputs.",       color: "#10b981" },
  { label: "JSON-LD Compliance Graph",            desc: "Machine-readable evidence graph linking dataset, fields, controls, metrics.",    color: "#fbbf24" },
  { label: "Dashboard Export Payload",            desc: "Structured JSON for visualization and reporting in the assessment console.",     color: "#6366f1" },
];
        ...
        <FadeUp>
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-left">
            {[
              ...
              <div key={item} className="flex items-start gap-2.5 text-sm text-slate-500 p-3 rounded-xl border" style={{ borderColor: "rgba(148,163,184,0.09)", background: "rgba(255,255,255,0.02)" }}>
